...
export const ContactModal: React.FC<ContactModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-[1px]">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full relative m-6 ">
        <Button
          variant="outline"
        ...
        <div className="flex flex-col gap-4 items-center">
          <a
            ...
            className="flex items-center gap-2 p-3 rounded-lg bg-cyan-50 hover:bg-cyan-100 border border-cyan-200 text-cyan-600 transition w-full justify-center"
            aria-label="LinkedIn"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 p-3 rounded-lg bg-green-50 hover:bg-green-100 border border-green-200 text-green-600 transition w-full justify-center"
            aria-label="WhatsApp"
          >
